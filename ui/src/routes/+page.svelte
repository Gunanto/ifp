...
<main class="page">
  <header class="hero">
    ...
    <nav class="nav">
      <a href="/teacher/questions">Kelola Soal</a>
      <a href="/teacher/classes">Kelola Kelas</a>
      <a href="/teacher/sessions">Kelola Sesi</a>
      <a href="/teacher/login">Login Teacher</a>
      <a href="/war">Mode Perang</a>
    </nav>
  </header>
